...
@Getter
@Setter
public class UserBookingsPageQuery {
    ...
    @Parameter(
            ...
            schema = @Schema(
                    type = "string",
                    allowableValues = { "id", "bookDate", "startDate", "endDate", "finalPrice", "status" },
                    defaultValue = "id"))
    @ValidateString(acceptedValues = { "id", "bookDate", "startDate", "endDate", "finalPrice", "status" })
